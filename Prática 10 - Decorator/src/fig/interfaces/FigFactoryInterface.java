...
public interface FigFactoryInterface {
	...
	/**
	 * Método para criar figura decorada;
	 * @param decoratorClass Classe que implementa o decorador.
	 * @param fig Figura onde a borda será aplicada.
	 * @return Figura com borda criada.
	 */
	DecoratorInterface createDecorator(Class decoratorClass, FigInterface fig);
