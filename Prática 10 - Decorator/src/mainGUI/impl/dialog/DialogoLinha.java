...
public class DialogoLinha extends DialogoBase {
  ...
  public DialogoLinha (Frame f) {
    ...
    p.add (new JLabel("Posição horizontal - primeiro ponto:"));
    tx = new JTextField();
    p.add (tx);
    p.add (new JLabel("Posição vertical - segundo ponto:"));
    ty = new JTextField();
    p.add (ty);
    p.add (new JLabel("Posição horizontal - segundo ponto:"));
    tx2 = new JTextField();
    p.add (tx2);
    p.add (new JLabel("Posição vertical - segundo ponto:"));
    ty2 = new JTextField();
  ...
  public void inicializa (int cor, int x, int y, int x2, int y2) {
