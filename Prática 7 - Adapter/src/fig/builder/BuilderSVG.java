...
public class BuilderSVG implements JaxbBuilderInterface {
	...
	public void buildCircle(CircleType circle) {
		file.println(
			"<circle cx=\"" + circle.getPosX() + "\" cy=\"" + circle.getPosY()
			+ "\" r=\"" + circle.getRadius() + "\" style=\"fill-opacity:0;stroke:#"
			+ circle.getColor() + "\" />");
	}

	public void buildRectangle(RectangleType rectangle) {
		file.println(
			"<rect x=\"" + rectangle.getPosX() + "\" y=\"" + rectangle.getPosY()
			+ "\" width=\"" + rectangle.getWidth()
			+ "\" height=\"" + rectangle.getHeight()
			+ "\" style=\"fill-opacity:0;stroke:#"
			+ rectangle.getColor() + "\" />");
	}

	public void buildLine(LineType line) {
		file.println(
			"<line x1=\"" + line.getPosX() + "\" y1=\"" + line.getPosY()
			+ "\" x2=\"" + line.getPosX2() + "\" y2=\"" + line.getPosY2()
			+ "\" style=\"fill-opacity:0;stroke:#" + line.getColor() + "\" />");
	}
}
